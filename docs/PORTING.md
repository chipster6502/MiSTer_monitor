...
- **Small to mid-size SPI panels (320x240, 480x320)** → start from
  `mister_monitor_CYD28R/`. Full-panel UI: artwork on top, button
...
| CYD 2.8" 2-USB (ESP32-2432S028) | ESP32 | 320x240 ST7789 | XPT2046 res. | CYD28R | Stable |
| CYD 3.5" cap. (ESP32-3248S035) | ESP32 | 480x320 ST7796 | GT911 cap. | CYD28R | Stable |
| CYD 3.5" res. (ESP32-3248S035) | ESP32 | 480x320 ST7796 | XPT2046 res. | CYD28R | Stable |
